...
| Mar 9              | Virtual Machines: EC2, Bash Script Deployment                                                          | Launch EC2, automate software install with bash, intro to launch templates                            |
| Mar 16             | CloudFormation Templates                                                                               | Infrastructure as Code: hardcoded templates to redeploy resources                                     |
| Mar 23             | Terraform to Recreate CloudFormation Resources                                                         | Use Terraform to automate and manage infrastructure                                                   |
